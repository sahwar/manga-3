...
if ($doubleSpread == true) {
  $chapterPages = ((($chapterPages - 1) / 2) + 1);
}
...
if ($chapter > 1 && $page == 1 && file_exists('data/' . $lang . '/ch/' . ($chapter - 1))){
  ...
  if ($doubleSpread == true) {
    $PrevChapterPages = ((($chapterArray['pages'] - 1) / 2) + 1);
  } else {
...
if ($doubleSpread == true && $page > 1) {
  $imageURL = 'content/' . $chapterKey . '/' . (($page - 1) * 2) . '.png';
  $imageURL2 = 'content/' . $chapterKey . '/' . ((($page - 1) * 2) + 1) . '.png';
} else {
